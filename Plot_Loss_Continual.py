...
rnn_loss_path = './RNN_losses_continual.npy'
gru_loss_path = './GRU_losses_continual.npy'
...
def PlotRNN(rnn_loss) : 
	...
	plt.savefig('RNNValidationLossComparisonContinual.pdf', dpi = 1000)
	plt.show()
	plt.close()
...
def PlotGRU(gru_loss) :
	...
	plt.savefig('GRUValidationLossComparisonContinual.pdf', dpi = 1000)
	plt.show()
...
def PlotFromNPY(rnn_loss, gru_loss, trf_loss) :
	...
	plt.savefig('ValidationLossComparisonContinual.pdf', dpi = 1000)
	plt.show()
